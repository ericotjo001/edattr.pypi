import os, argparse
from setup import *
from toydata2 import prep_toyexample_dir, save_toyexample_csv
...
def toy_kfold_train_val_test_endorse(parser):
    ...
    if TOGGLE[4] == '1':
        ...
        cml = kFoldK2CommonMLClassifierPipeline(kf,TARGET_LABEL_DICTIONARY=None)
...
def toy2_kfold_aggregate(parser):
    ...
    aggregate_endorsement_samples(DataSetupTypeK2, DatasetKFoldClassifierTypeK2CSV, 
...
def toy2_compare(parser):
    parser.add_argument('best.metric', default='f1', type=str, help="Choose the model with this best metric for comparison.")
...
def toy2_compare_aggregate(parser):
    print('toy2_compare_aggregate...')
    parser.add_argument('best.metric', default='f1', type=str, help=None)
    parser.add_argument('--label_suffix', default='toy2_kfold', type=str, help=None)
...
if __name__=='__main__':
    ...
    parser.add_argument('--DATA_FILE_NAME', default='toyexample2.csv', type=str, help=None)
    ...
    parser.add_argument('--full_projectname', default='toyclassifier2', type=str, help=LABEL_INFO)
